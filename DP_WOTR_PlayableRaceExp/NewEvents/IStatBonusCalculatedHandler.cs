        ...
        private class EventTriggers {
            ...
            static class AddStatBonus_Idealize_Patch {
                ...
                static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions) {
                    ...
                    //Utilities.ILUtils.LogIL(RaceExpContext, codes);
                ...
                private static int FindInsertionTarget(List<CodeInstruction> codes, int startingIndex = 0) {
                    ...
                    if (target < 0) {
                        RaceExpContext.Logger.Log("ADD STAT IDEALIZE PATCH - AddStatBonus: COULD NOT FIND TARGET");
                    }
                    return target;
                }
            ...
            static class AddContextStatBonus_Idealize_Patch {
                ...
                private static int FindInsertionTarget(List<CodeInstruction> codes, int startingIndex = 0) {
                    ...
                    if (target < 0) {
                        RaceExpContext.Logger.Log("ADD STAT IDEALIZE PATCH - AddContextStatBonus: COULD NOT FIND TARGET");
                    }
                    return target;
                }
            ...
            static class AddGenericStatBonus_Idealize_Patch {
                ...
                private static int FindInsertionTarget(List<CodeInstruction> codes, int startingIndex = 0) {
                    ...
                    if (target < 0) {
                        RaceExpContext.Logger.Log("ADD STAT IDEALIZE PATCH - AddGenericStatBonus: COULD NOT FIND TARGET");
                    }
                    return target;
                }
