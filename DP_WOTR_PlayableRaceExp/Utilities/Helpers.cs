...
namespace DP_WOTR_PlayableRaceExp.Utilities {
    ...
    public static class Helpers {
		...
		public static T Get<T>(BlueprintGuid id) where T : SimpleBlueprint {
			...
			T value = asset as T;
			//if (value == null) { ModLogger.LogError($"COULD NOT LOAD: {id} - {typeof(T)}"); }
			return value;
		}
        ...
        /// </param>
        public static T CreateBlueprint<T>(ModContextBase modContext, string name, Action<T> init = null) where T : SimpleBlueprint, new() {
            var result = new T {
                name = name,
        ...
        /// Action to initialize the new blueprint with.
        /// </param>
        public static T CreateDerivedBlueprint<T>(ModContextBase modContext, string name, BlueprintGuid masterId, IEnumerable<SimpleBlueprint> componentBlueprints, Action<T> init = null) where T : SimpleBlueprint, new() {
            var result = new T {
                name = name,
