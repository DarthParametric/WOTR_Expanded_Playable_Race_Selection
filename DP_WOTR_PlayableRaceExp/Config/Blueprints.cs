...
namespace DP_WOTR_PlayableRaceExp.Config {
    public class Blueprints : IUpdatableSettings {
        ...
        [JsonProperty]
        private readonly SortedDictionary<string, Guid> NewBlueprints = new SortedDictionary<string, Guid>(StringComparer.InvariantCulture);
        [JsonProperty]
        private readonly SortedDictionary<string, Guid> DerivedBlueprintMasters = new SortedDictionary<string, Guid>(StringComparer.InvariantCulture);
        [JsonProperty]
        private readonly SortedDictionary<string, Guid> DerivedBlueprints = new SortedDictionary<string, Guid>(StringComparer.InvariantCulture);
        [JsonProperty]
        private readonly SortedDictionary<string, Guid> AutoGenerated = new SortedDictionary<string, Guid>(StringComparer.InvariantCulture);
        [JsonProperty]
        private readonly SortedDictionary<string, Guid> UnusedGUIDs = new SortedDictionary<string, Guid>(StringComparer.InvariantCulture);
        private readonly SortedDictionary<string, Guid> UsedGUIDs = new SortedDictionary<string, Guid>(StringComparer.InvariantCulture);
        [JsonIgnore]
        ...
        public BlueprintGuid GetDerivedGUID(string name, BlueprintGuid masterId, params BlueprintGuid[] componentIds) {
            Guid Id;
            if (!DerivedBlueprints.TryGetValue(name, out Id)) {
        ...
        public BlueprintGuid DeriveGUID(string name, BlueprintGuid masterId, params BlueprintGuid[] componentIds) {
